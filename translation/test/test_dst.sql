...
------------------------
SELECT TT_CreateMappingView('rawfri', 'nt04', 1, 'nt', 1, 800, NULL, 'dst'); -- Generates about 200 (228) DST rows
INSERT INTO casfri50_test.dst_all_new
SELECT * FROM TT_Translate_nt_dst_test('rawfri', 'nt04_l1_to_nt_l1_map_800_dst');
------------------------
