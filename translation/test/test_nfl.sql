...
------------------------
SELECT TT_CreateMappingView('rawfri', 'nt04', 3, 'nt', 1, 1300, NULL, 'nfl'); -- Generates about 200 (223) NFL rows
INSERT INTO casfri50_test.nfl_all_new
SELECT * FROM TT_Translate_nt_nfl_test('rawfri', 'nt04_l3_to_nt_l1_map_1300_nfl');
------------------------
