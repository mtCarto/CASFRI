...
------------------------
SELECT TT_CreateMappingView('rawfri', 'nt04', 'nt', 950, NULL, 'eco'); -- Generates about 200 (201) ECO rows
INSERT INTO casfri50_test.eco_all_new
SELECT * FROM TT_Translate_nt_eco_test('rawfri', 'nt04_l1_to_nt_l1_map_950_eco');
------------------------
