...
-- CAS
------------------------
SELECT TT_Prepare('translation', 'mb_fri02_cas', '_mb09_cas', 'ab_avi01_cas');
...
SELECT * FROM TT_Translate_mb01_cas('rawfri', 'mb09_l1_to_mb_fri2_l1_map');
...
SELECT * FROM TT_Translate_mb01_dst('rawfri', 'mb09_l1_to_mb_fri2_l1_map');


------------------------
-- ECO
------------------------
SELECT TT_Prepare('translation', 'mb_fri02_eco', '_mb09_eco', 'ab_avi01_eco');
...
SELECT * FROM TT_Translate_mb01_eco('rawfri', 'mb09_l1_to_mb_fri2_l1_map');
...
-- Add translated ones
-- Layer 1
SELECT TT_CreateMappingView('rawfri', 'mb09', 1, 'mb_fri2', 1);

INSERT INTO casfri50.lyr_all --
SELECT * FROM TT_Translate_mb09_lyr('rawfri', 'mb09_l1_to_mb_fri2_l1_map');
...
SELECT * FROM TT_Translate_mb01_nfl('rawfri', 'mb09_l2_to_mb_fri2_l1_map');


------------------------
-- GEO
------------------------
SELECT TT_Prepare('translation', 'mb_fri02_geo', '_mb09_geo', 'ab_avi01_geo');
...
SELECT * FROM TT_Translate_mb01_geo('rawfri', 'mb09_l1_to_mb_fri2_l1_map');
