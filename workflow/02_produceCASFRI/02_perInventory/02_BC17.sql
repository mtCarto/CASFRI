...
------------------------
BEGIN;
SELECT TT_Prepare('translation', 'bc_vri01_eco', '_bc17_eco', 'ab_avi01_eco'); -- used for both bc13 and BC10
...
SELECT TT_Prepare('translation', 'bc_vri01_lyr', '_bc17_lyr', 'ab_avi01_lyr');
...
SELECT * FROM TT_Translate_bc13_lyr('rawfri', 'bc17_l1_to_bc_l1_map');
...
BEGIN; -- **h42m
SELECT TT_Prepare('translation', 'bc_vri01_nfl', '_bc17_nfl', 'ab_avi01_nfl'); -- used for both BC13 and BC10
...
SELECT * FROM TT_Translate_bc17_nfl('rawfri', 'bc17_l2_to_bc_l1_map');
...
------------------------
BEGIN;
SELECT TT_Prepare('translation', 'bc_vri01_geo', '_bc17_geo', 'ab_avi01_geo'); -- used for both BC13 and BC10
