...
# This dataset is split into 2 geodatabases, layer 1, and layer 2
...
srcFullPath_L1="$friDir/BC/$inventoryID/data/inventory/${srcFileName_L1}_2020.gdb"

srcFileName_L2=${srcFileName}_L2_POLY
srcFullPath_L2="$friDir/BC/$inventoryID/data/inventory/${srcFileName_L2}_2020.gdb"
