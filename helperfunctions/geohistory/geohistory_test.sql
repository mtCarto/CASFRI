...
-----------------------------------------------------------------------------
--- test geohistory_overlap fix for geos topology error thrown by st_overlap
-----------------------------------------------------------------------------
UNION ALL
(WITH poly1 AS (
   SELECT ST_GeomFromText('MULTIPOLYGON(((2363405.4588294416 1313008.8486092,2363420.0812119357 1313001.5433654645,2363420.0812119357 1313001.5433654648,2363420.081211938 1313001.5433654597,2363420.609792703 1313000,2363407.9701151643 1313000,2363407.790029545 1313002.5482584757,2363405.4588294416 1313008.8486092)))',102001) geom
  ),
  poly2 AS (
   SELECT ST_Multi(ST_GeomFromText('POLYGON((2363420.0812119357 1313001.5433654645,2363425.27313627 1313005.097259047,2363428.482406054 1313006.803543722,2363430.4023054177 1313009.0413773672,2363434.9353353423 1313019.7120705752,2363435.743039206 1313005.1176418033,2363436.350176773 1313000,2363420.609792703 1313000,2363420.0812119357 1313001.5433654645))',102001)) as geom

 )
 SELECT '7.1'::text number,
        'TT_GeoHistoryOverlaps'::text function_tested,
        'Test to ensure overlap below threshold returns false' description,
        TT_GeoHistoryOverlaps(p1.geom,p2.geom) = FALSE passed,
        '' check_query
