------------------------------------------------------------------------------
-- CASFRI - Helper functions uninstall script for CASFRI v5
...
DROP FUNCTION IF EXISTS TT_nl_nli02_origin_newfoundland_validation(text);
...
DROP FUNCTION IF EXISTS TT_yvi03_nfl_soil_moisture_validation(text,text,text,text,text);
